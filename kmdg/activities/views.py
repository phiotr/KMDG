...
@csrf_exempt
def view_news(request, page_nr=1):
    ...
    # Jesli takiej strony nie ma, to 404
        ...
        c = RequestContext(request, {'sitetitle': u"Aktualności", 'news_page': page})

        return render_to_response('pages/news.html', c)


@csrf_exempt
def view_calendar(request, page_nr=1):
    ...
    # Jesli takiej strony nie ma, to 404
        ...
        c = RequestContext(request, {'sitetitle': u'Kalendarium spotkań', 'calendar_page': page, 'url': '/kalendarium'})

        return render_to_response('pages/calendar.html', c)
